...
- Alias: `codex-terra`, `codex-sol`, `codex-luna`, `sonnet`, or `haiku`.
...
- Prefer a different model family for high-risk review: review Codex-written changes with Claude, or Claude-written changes with Codex.
